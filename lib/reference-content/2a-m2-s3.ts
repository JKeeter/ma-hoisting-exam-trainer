...
const data: ReferencePageProps = {
  ...
  subtitle: 'MA 2A Hoisting License · Module 2, Session 3',
  criticalAlert: {
      ...
      content: [
        {
          ...
          body: `Excavator hydraulic systems operate at pressures that are fundamentally incompatible with human tissue:
...
**Fire risk:** Hydraulic fluid is not as flammable as gasoline, but it is combustible when in a fine mist (which a burst hose creates). Keep the work area clear of ignition sources when doing hydraulic work.`,
    ...
    {
      id: 'pumps-circuits',
      title: 'Pump Types & Circuit Basics',
      icon: '⚙️',
      ...
      content: [
        {
          ...
          body: `Modern excavators use **axial piston pumps** as main hydraulic pumps.
...
**Common sizes:** 18, 45, 71, 100 cc per revolution (more cc = more flow at the same RPM).`,
        },
        {
          ...
          body: `Most modern excavators use a **load-sensing hydraulic system**.
...
**Exam application:** If asked why a modern excavator is more fuel efficient than an older model, load-sensing hydraulics is a key reason.`,
  ...
  quickFacts: [
    ...
    { label: 'Main pump type (modern excavators)', value: 'Variable displacement axial piston pump' },
  ],
