...
const data: ReferencePageProps = {
  ...
  subtitle: 'MA 2A Hoisting License · Module 1, Session 1',
  sections: [
    {
      id: 'definition',
...
**Apprentice license restriction:** The apprentice license specifies which equipment may be operated and under what conditions.`,
        },
        {
          ...
          body: `**License validity:** The 2A hoisting engineer license is valid for **2 years** from the date of issuance.
