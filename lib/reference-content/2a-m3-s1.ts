...
const data: ReferencePageProps = {
  ...
  subtitle: 'MA 2A Hoisting License · Module 3, Session 1',
  sections: [
    {
      id: 'osha-basis',
...
☐ **Air filter restriction indicator:** Most machines have a yellow/red service indicator visible without removing the filter. Service when in red zone.`,
    ...
    },
    {
      ...
      title: 'Step 3 — Undercarriage (Excavators)',
      icon: '⚙️',
      color: 'border-slate-400',
      headerBg: 'bg-slate-100',
      content: [
...
☐ **Mud packing:** Clear any compacted mud or debris from track voids — packed mud overloads the undercarriage and affects track tension.`,
    ...
    },
    {
      ...
      title: 'Step 4 — Boom, Stick & Bucket',
      icon: '🦾',
      color: 'border-yellow-500',
      headerBg: 'bg-yellow-50',
      content: [
        {
          heading: 'Structural & Attachment Checklist',
          body: `☐ **Boom base welds:** Inspect the weld at the boom foot (where it attaches to the upperstructure). This is the highest-stress point. Any crack visible to the naked eye = remove from service.
...
**Tip:** Use a standardized inspection form (paper or digital) — it ensures consistency and provides a defensible record. A blank form with "all ok" written in is not an inspection.`,
    ...
    {
      id: 'skid-steer-additions',
      title: 'Skid Steer — Additional Inspection Points',
      icon: '🚜',
      color: 'border-indigo-400',
      headerBg: 'bg-indigo-50',
      content: [
        {
          heading: 'Skid Steer-Specific Checks',
          body: `In addition to the general checklist above, skid steers require these additional checks:
